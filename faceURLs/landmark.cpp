...
int main(int argc, char *argv[]){
	...
	while(getline(DetectionDataStream, line)) {
		...
		string cmd = "curl \"http://apius.faceplusplus.com/v2/detection/landmark?api_key=2b330a1611e4780dee14b2666c2e6ef7&api_secret=TOMk3pSLwtrBut3S7VDER6PxrxauYABl&face_id=" + face_id + "&type=25p\"";
		system(cmd.c_str());
		cout << endl;
	}
